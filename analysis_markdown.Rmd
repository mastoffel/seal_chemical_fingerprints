---
title: R-code containing all analyses from our manuscript "Fur seal chemical fingerprints encode colony membership, mother-offspring similarity,
...
For running the complete code you need two additional functions (`get_pairdiff` and `multiplot`) which are outsourced as well as the `files` folder as a subfolder.
