...
The Rmarkdown .Rmd file as well as the PDF and the data are stored on [GitHub](https://github.com/mastoffel/seal_chemical_fingerprints). Just click on the link and then klick on *Download ZIP* on the right hand side of the page. For any questions just contact me: `martin.adam.stoffel[at]gmail.com`.
