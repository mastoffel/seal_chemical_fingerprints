...
In addition, we provide our data files, which should be placed in a subfolder called *files*. Our data files contain:
...
* coordinates_beach1 contains euclidian coordinates for seals on the special study beach
* bootstrap_mums contains results from the BIO-ENV bootstrap procedure (see Rmarkdown file or Methods of the paper)
* relatedness contains pairwise relatedness values for all individuals (Queller&Goodnight)